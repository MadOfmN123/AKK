...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setPixmap(QtGui.QPixmap("../../IMAGES/G.U.I Material/ExtraGui/Jarvis_Gui (2).gif"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(Dialog)
        self.label_3.setGeometry(QtCore.QRect(100, 390, 511, 111))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap("../../IMAGES/st and sti.png"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.pushButton = QtWidgets.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(170, 400, 111, 91))
        self.pushButton.setStyleSheet("border-image : url(C:/Users/HI/Downloads/5379967-removebg-preview.png)")
        self.pushButton.setText("")
        self.pushButton.setObjectName("pushButton")

        self.pushButton_2 = QtWidgets.QPushButton(Dialog)
        self.pushButton_2.setGeometry(QtCore.QRect(420, 400, 111, 91))
        self.pushButton_2.setStyleSheet("border-image : url(C:/Users/HI/Downloads/LOGIN_prev_ui.png)")
        self.pushButton_2.setText("")
        self.pushButton_2.setObjectName("pushButton_2")

        self.label_4 = QtWidgets.QLabel(Dialog)
        self.label_4.setGeometry(QtCore.QRect(120, -10, 499, 100))
        self.label_4.setPixmap(QtGui.QPixmap("C:\\Users\\HI\\Downloads\\Untitled_design.png"))
